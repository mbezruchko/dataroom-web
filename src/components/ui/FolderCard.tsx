...
export const FolderCard = ({ folder, onFavoriteToggle, onDelete }: FolderCardProps) => {
  ...
  return (
    <>
      <Link to={`/${workspaceGuid}/folder/${folder.guid}`} className="group relative">
      ...
      <DeleteConfirmationDialog
        ...
        title="Delete Folder"
        description={`Are you sure you want to delete "${folder.name}"? All files inside will be moved to Trash.`}
      />
    </>
  )
}